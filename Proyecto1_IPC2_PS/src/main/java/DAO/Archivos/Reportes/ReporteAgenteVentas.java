 ...
 * @author millin-115
 */
public class ReporteAgenteVentas {
    ...
    public void generarPDF(List<ReservacionDB> reservaciones, String fechaInicial, String fechaFinal, OutputStream output) {
        try (PDDocument documento = new PDDocument()) {
            ...
            try (PDPageContentStream contenido = new PDPageContentStream(documento, pagina)) {
                ...
                contenido.showText("Reportes del agente con mas ventas entre fechas: "+fechaInicial+" y "+fechaFinal);
                contenido.newLine();
                contenido.showText("El agente es : "+reservaciones.get(0).getNombreCliente());
                contenido.newLine();
                contenido.newLine();
